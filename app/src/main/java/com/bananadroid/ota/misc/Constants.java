...
public final class Constants {
    ...
    static final String OTA_URL = "https://raw.githubusercontent.com/bananadroid-devices/official_devices/master/API/updater/%s.json";
    static final String MAINTAINER_URL = "https://github.com/%s";
    static final String DOWNLOAD_WEBPAGE_URL = "https://bananadroid.com/download#%s";
